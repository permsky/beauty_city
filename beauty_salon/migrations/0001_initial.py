# Generated by Django 4.1.4 on 2022-12-09 19:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='code', to=settings.AUTH_USER_MODEL, verbose_name='клиент')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('available', 'available'), ('busy', 'busy')], default='available', max_length=10, verbose_name='статус')),
                ('master', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='schedule_points', to='beauty_salon.master', verbose_name='мастер')),
            ],
            options={
